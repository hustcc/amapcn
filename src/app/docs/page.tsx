    ...
    >
      ...
      <DocsSection title="Why amapcn?">
        ...
        <ul>
          ...
          <li>
            ...
            Built directly on AMap. Drop to the raw API whenever you need.
          </li>
          <li>
          ...
          <li>
            ...
            your own tiles — AMap official or custom
            source.
          </li>
        </ul>
      </DocsSection>
      ...
      <DocsSection title="Why AMap Directly?">
        ...
        <p>
          ...
          AMap APIs anytime without &quot;escaping&quot; a wrapper.
        </p>
      </DocsSection>
      ...
      <DocsSection title="Any Map Style">
        ...
        <ul>
          ...
          <li>And any other provider that supports the AMap style spec</li>
        </ul>
      </DocsSection>
